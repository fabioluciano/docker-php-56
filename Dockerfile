...
RUN yum groupinstall 'Development Tools' -y && yum install -y httpd php56w-pear php56w-common php56w-opcache php56w-mbstring php56w-opcache php56w-mcrypt php56w-intl php56w-devel php56w-gd php56w-ldap php56w-mysql php56w-pdo php56w-pgsql php56w-xml initscripts &&  yum clean all
